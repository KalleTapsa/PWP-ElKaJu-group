...
from ..utils import (
    ...
    get_report_places_by_place,
    get_report_places_by_user,
    get_report_review_by_id,
    get_report_reviews_by_review,
    get_report_reviews_by_user,
    get_review_by_id,
)
...
class AllPlaceReports(Resource):
    ...
    def post(self, place_id):
        ...
        try:
            ...
            return make_response(
                jsonify(
                    {"id": report.id, "message": "Place report created successfully"}
                ),
                201,
            )
...
class AllImageReports(Resource):
    ...
    def post(self, place_id, image_id):
        ...
        try:
            ...
            return make_response(
                jsonify(
                    {"id": report.id, "message": "Image report created successfully"}
                ),
                201,
            )
